#ifndef TRAVELLING_THIEF_PROBLEM_TTPDEPR_H
#define TRAVELLING_THIEF_PROBLEM_TTPDEPR_H
...
namespace ttp {
     ...
     *
     */
    class TravellingThiefProblemDeptr {
    ...
    protected:
        ...
        double minSpeed = DEFAULT_MIN_SPEED;
        ...
        double rentingRate = DEFAULT_RENTING_RATE;

        /*!< Dropping rate for the MOP */
        double droppingRate = DEFAULT_DROPPING_RATE;

        /*!< Dropping constant for the MOP */
        double droppingConstant = DEFAULT_DROPPING_CONSTANT;
    ...
    public:
         ...
         */
        TravellingThiefProblemDeptr(MapPtr map, int maxWeight) : m(map), maxWeight(maxWeight){}
         ...
         */
        TravellingThiefProblemDeptr(MapPtr map, vector<ItemPtr>, int itemsPerCity, int maxWeight);

        /**
         * Add multiple items to this problem
         */
         ...
         */
        TTPOutput evaluateMO(Tour &t, Knapsack &k, double droppingRate = DEFAULT_DROPPING_RATE, double droppingConstant = DEFAULT_DROPPING_CONSTANT);
         ...
         * fills the stream with a json representation of this object.
         */
        static TravellingThiefProblemDeptr fromJson(std::istream &s);
